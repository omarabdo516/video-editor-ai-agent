...
/** Thumbnail JPEG for the dashboard:  _pipeline/<basename>/thumb.jpg */
export function thumbnailPath(videoPath) {
  return path.join(pipelineDir(videoPath), 'thumb.jpg');
}
...
export function derivedOutputs(videoPath) {
  return {
    ...
    thumbnail: thumbnailPath(videoPath),
